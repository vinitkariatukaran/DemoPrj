package com.demoprj.DeliveryBoyApp.SegmentDeliveryBoy;
...
import com.demoprj.DeliveryBoyApp.AdapterDeliveryBoy.DeliveryDetailAdapterofDeliveryBoy;
 ...
 */
public class DeliverySegmentofDeliveryBoy extends Fragment implements View.OnClickListener, TextWatcher {
    ...
    public void FetchingDeliveryData(Calendar now2){
        ...
        if(Utils.isInternetAvailable(getActivity())) {
            ...
            gasBookingQuery.whereEqualTo(AppConstant.GASBOOKING_DELIVERYBOY_ID, ParseObject.createWithoutData("_User", ParseUser.getCurrentUser().getObjectId()));
                ...
                public void done(List<GasBooking> objects, ParseException e) {
                    if (e == null) {
                        if (objects.size() > 0) {
                            ...
                            adapter = new DeliveryDetailAdapterofDeliveryBoy(getActivity(), (ArrayList<GasBooking>) objects,1);
...
//        startActivity(next);
    ...
    public void afterTextChanged(Editable s) {
        ...
        adapter = new DeliveryDetailAdapterofDeliveryBoy(getActivity(), searchUserList,1);
        rvDeliveryDetail.setAdapter(adapter);
    }
}
