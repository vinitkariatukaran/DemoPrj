 ...
 */
public class
        UndeliverySegmentofDeliveryBoy extends Fragment implements View.OnClickListener, TextWatcher {
                ...
                public void done(List<GasBooking> objects, ParseException e) {
                    if (e == null) {
                        if (objects.size() > 0) {
                            ...
                            adapter = new DeliveryDetailAdapterofDeliveryBoy(getActivity(), (ArrayList<GasBooking>) objects,2);
...
//        startActivity(next);
    ...
    public void afterTextChanged(Editable s) {
        ...
        adapter = new DeliveryDetailAdapterofDeliveryBoy(getActivity(), searchUserList,2);
        rvDeliveryDetail.setAdapter(adapter);
    }
}
