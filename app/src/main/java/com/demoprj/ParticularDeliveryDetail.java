                ...
                public void done(List<GasBooking> objects, ParseException e) {
                    if(e==null){
                        if(objects.size()>0){
                            ...
                            lblParticularDeliveryCustomerId.setText(u.getCustomerId() + "");
                            lblParticularDeliveryCustomerName.setText(u.getFirstName() + " " + u.getLastName());
                            lblParticularDeliveryCustomePhNo.setText(u.getphoneNumber()+"");
                            ...
                            lblParticularDeliveryCustomerLandmark.setText(u.getLandmark());
                            if (!gasBooking.getisService()) {
                                ...
                                gasTypeQuery.findInBackground(new FindCallback<GasType>() {
                                    ...
                                    public void done(List<GasType> objects, ParseException e) {
                                        if (e == null) {
                                            if (objects.size() > 0) {
                                                lblParticularDeliveryGasType.setText(objects.get(0).getGasType());
                                            }
                                        } else {
                            ...
                            if (gasBooking.getisService()) {
                                ...
                                lblParticularDeliveryServiceCharge.setText(gasBooking.getServiceCharge());
                                lblParticularDeliveryServiceNote.setText(gasBooking.getServiceNote());
                            } else {
                                ...
                                if(gasBooking.has(AppConstant.GASBOOKING_DELIVERY_CHARGE)) {
                                    lblParticularDeliveryGasPrice.setText((gasBooking.getTotal() - (Double.parseDouble(gasBooking.getDeliveryCharge()))) + "");
                                    lblParticularDeliveryCharge.setText(gasBooking.getDeliveryCharge() + "");
                                    lblParticularDeliveryTotal.setText(gasBooking.getTotal() + "");
                                }else{
                                    lblParticularDeliveryGasPrice.setText(gasBooking.getTotal() + "");
                                ...
                                if(gasSize!=null) {
                                    lblParticularDeliveryGasSize.setText(gasSize.getGasSize() + "");
                                }
                                lblParticularDeliveryGasQuantity.setText(gasBooking.getQuantity() + "");
                            }
                            ParseUser db = (ParseUser) gasBooking.get(AppConstant.GASBOOKING_DELIVERYBOY_ID);
                            DeliveryBoy = db.getUsername();
                            lblParticularDeliveryBoy.setText(db.getUsername());
