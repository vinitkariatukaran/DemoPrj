...
public class ExpenseDetailAdapter extends RecyclerView.Adapter<ExpenseDetailAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(ViewHolder viewHolder, int i) {
        ...
        viewHolder.lblExpenseDeliveryBoy.setText(user.getUsername());
        viewHolder.lblExpenseDeliveryExpense.setText(expenseList.get(i).getAmount()+"");
        viewHolder.lblExpenseDeliveryTotal.setText(expenseList.get(i).getDeliveryAmount()+"");
        Double total = expenseList.get(i).getDeliveryAmount() - expenseList.get(i).getAmount();
    ...
    class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View v) {
            if(Utils.isInternetAvailable(context)){
                ...
                next.putExtra("ObjectId",user.getObjectId());
