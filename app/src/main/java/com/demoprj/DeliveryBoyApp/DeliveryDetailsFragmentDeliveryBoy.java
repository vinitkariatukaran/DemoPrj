...
public class DeliveryDetailsFragmentDeliveryBoy extends Fragment implements RadioGroup.OnCheckedChangeListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        fragment=new UndeliverySegmentofDeliveryBoy();
    ...
    public void onCheckedChanged(RadioGroup group, int checkedId) {
        switch (checkedId) {
            ...
            case R.id.rbDelivery:
                isDelivered = true;
                fragment=new DeliverySegmentofDeliveryBoy();
